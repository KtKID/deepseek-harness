...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-plugin-analyzer': { kind: 'none', reason: 'Browser-side enabled-plugin diagnosis projection; registers nothing model-facing.' },
  ...
  'packages/host/plugin-analyzer': { kind: 'none', reason: 'Host-side read-only runtime diagnostics; registers nothing model-facing.' },
  ...
  'packages/bundle/plugin-analyzer': { kind: 'indirect', reason: 'The bundle mounts Host and Client diagnostics packages that register nothing model-facing.' },
