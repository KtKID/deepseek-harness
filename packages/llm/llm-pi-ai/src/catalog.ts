...
const COMPLETIONS_COMPAT_GATE = {
  ...
  // Upstream catalogs leave the reasoning-token cap unset; the harness never
  // exercises it, so the gate claims nothing.
...
const ANTHROPIC_COMPAT_GATE = {
  ...
  // Fallback targets are a provider-routing concern the harness never sets.
