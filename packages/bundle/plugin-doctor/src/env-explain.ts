 ...
 *
 * @module @deepseek-ai/dsh-plugin-doctor/env-explain
 */
...
/** Secret-free resolution state for one environment source. */
...
/** One environment source and why it won, lost, or could not be read. */
