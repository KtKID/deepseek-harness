...
| [`plugin-analyzer`](plugin-analyzer/README.zh.md) | 选择启用的 Host 插件行为诊断与 Web 设置标签页 | 挂载 Analyzer 配置项 |
| [`plugin-doctor`](plugin-doctor/README.zh.md) | 可安装的插件与 profile 健康检查，提供 CLI 和模型工具 | 挂载 `plugin-doctor` |
