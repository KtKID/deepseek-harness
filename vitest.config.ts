...
const testIncludes = [
  ...
  // The analyzer-fault-plugins demo package keeps its fault-pinning suite
  // beside the plugins it exercises; it is app-owned demo content, not a
  // workspace package.
  'apps/*/config/examples/*/tests/**/*.spec.ts',
  'scripts/**/*.spec.ts',
